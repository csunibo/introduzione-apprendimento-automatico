# -*- coding: utf-8 -*-
"""Elaborazione Immagini - Soluzione Shining.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1kkL3lr6uaa13lxknMdoJefi4vNhW1fB4
...
def shining():
    ...
    duvall_blue[:, :, 0] -= 50
    duvall_blue[:, :, 1] -= 20
    duvall_blue = np.clip(duvall_blue, 0, 255).astype(np.uint8)
